...
% cfg.epochMEG_event_order(1)=3002;
% cfg.epochMEG_event_order(2)=3005;
% cfg.epochMEG_event_order(3)=3008;
% cfg.epochMEG_event_order(4)=3011;
% cfg.epochMEG_event_order(5)=3014;
% cfg.epochMEG_event_order(6)=3017;

cfg.epochMEG_event_order(1)=256;
cfg.epochMEG_event_order(2)=512;

% 
% cfg.epochMEG_event_order(7)=8;
% cfg.epochMEG_event_order(8)=9;
% cfg.epochMEG_event_order(9)=10;
% cfg.epochMEG_event_order(10)=11;
% cfg.epochMEG_event_order(11)=12;
% cfg.epochMEG_event_order(12)=13;
% 
% cfg.epochMEG_event_order(13)=14;
% cfg.epochMEG_event_order(14)=15;
% cfg.epochMEG_event_order(15)=16;
% cfg.epochMEG_event_order(16)=17;
% cfg.epochMEG_event_order(17)=18;
...
%     end
%     
    cfg1.customeventFileName = [cfg.data_rootdir '/' subj '/' visitNo{isubj} '/' subj '_' ,cfg.protocol, '_' num2str(run) '_decim_recode_sss_mergestim-eve.fif'];
